...
from .seqstuff import seqcheck, format_seq, reverse, complement, reverse_complement, expand_degenerates
...
__all__ = [
        'seqcheck', 'format_seq', 'reverse', 'complement', 'reverse_complement', 'expand_degenerates',
